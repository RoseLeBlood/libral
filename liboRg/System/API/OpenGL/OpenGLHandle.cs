...
{
	public class OpenGLHandle : UnmanagedHandle
	{
		...
		protected OpenGLHandle(string strName)
			: this(strName, IntPtr.Zero)
		{
		}
		protected OpenGLHandle(string strName, IntPtr pHandle)
			: base((strName.Contains("OpenGL_") ? strName : ("OpenGL_" + strName)), pHandle)
		{
		}

	}

	public class OpenGLHandles<T> : OpenGLHandle, IList<T>
		where T : OpenGLHandle
	{
		...
		protected OpenGLHandles(string strName)
			: base(strName)
		{
